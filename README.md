...
├── tools/
│   ├── commons.py           # Shared DAG utilities (parsing, NetworkX conversion)
│   ├── dag_identifiability.py  # Interactive DAG creation + DoWhy identify_effect
│   ├── dag_explorer.py      # Streamlit UI for DAG visualization + identifiability
