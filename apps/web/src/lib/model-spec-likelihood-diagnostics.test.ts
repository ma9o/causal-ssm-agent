...
describe("buildModelSpecLikelihoodDiagnostics", () => {
  it("builds per-likelihood histograms from full observations and preserves validation_report profiles", () => {
    ...
    const diagnostics = buildModelSpecLikelihoodDiagnostics({
      likelihoods,
      indicatorAudits,
      observations,
    });
