...
export const stage4Data = {
  ...
  likelihood_diagnostics: buildStage4LikelihoodDiagnostics({
    likelihoods: stage4.statistical_model_spec.likelihoods,
    indicatorAudits: stage3.indicators,
    observations: combinedExtractionsSample,
  }),
} as Stage4Data;

export const likelihoods = stage4Data.statistical_model_spec.likelihoods;
export const parameters = stage4Data.statistical_model_spec.parameters;
export const priors = collectStage4UiPriors(stage4Data);
export const indicators = stage1b.causal_design.measurement.indicators;
