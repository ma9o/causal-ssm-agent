import { DataSummaryStats } from "@/components/analysis-widgets/raw-data/data-summary-stats";
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        />
        <ExploreDataframeButton artifactId="raw_data" workspaceId={workspaceId} />
      </div>
