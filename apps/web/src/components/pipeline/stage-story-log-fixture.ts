...
const STORY_LOG_MESSAGES = [
  ...
  { level: 30, message: "Column 'mood_score' has 12% missing values; carrying forward last observed value" },
  ...
  { level: 30, message: "Implied independence Sleep->Appetite not supported (p=0.003); flagging for review" },
  ...
  { level: 30, message: "One latent factor shows weak identifiability; widening uncertainty interval" },
