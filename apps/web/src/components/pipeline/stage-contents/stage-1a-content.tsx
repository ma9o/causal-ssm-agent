...
import { ConstructDetailPanel } from "@/components/stages/latent-structure/construct-detail-panel";
import { EdgeList } from "@/components/stages/latent-structure/edge-list";
