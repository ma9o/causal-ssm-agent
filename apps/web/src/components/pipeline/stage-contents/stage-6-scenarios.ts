...
import type { LLMTrace, Stage1aData, Stage4Data, Stage5bData } from "@nof1-causal-lab/api-types";
...
export interface Stage6Scenario {
...
function toScenario(raw: RawSimulation): Stage6Scenario {
