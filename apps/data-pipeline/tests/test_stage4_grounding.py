    ...
    return {
        ...
        "parameters": [
            ...
            },
            {
                ...
                "search_context": "sleep autocorrelation",
            },
            {
                ...
                "search_context": "stress sleep effect size",
            },
            {
                "name": "sigma_pss_score",
                "role": "residual_sd",
                "constraint": "positive",
                "description": "Residual SD for PSS",
                "search_context": "PSS variability",
            },
            {
                "name": "sigma_sleep_quality",
                "role": "residual_sd",
                "constraint": "positive",
                "description": "Residual SD for sleep quality",
                "search_context": "sleep quality variability",
            },
        ],
    }
