...
DIRECT_EFFECT = IdentificationScenario(
    ...
    capability="identification:backdoor",
    latent_model={
...
BOW_ARC = IdentificationScenario(
    name="id_bow_arc",
    capability="identification:latent_confounding",
    latent_model={
        "constructs": [
            _construct("X"),
...
FRONT_DOOR = IdentificationScenario(
    name="id_front_door",
    capability="identification:front_door",
    latent_model={
        "constructs": [
            _construct("X"),
            _construct("M"),
...
INSTRUMENT = IdentificationScenario(
    name="id_instrument",
    capability="identification:instrument",
    latent_model={
        "constructs": [
            _construct("X"),
            _construct("Y", is_outcome=True),
