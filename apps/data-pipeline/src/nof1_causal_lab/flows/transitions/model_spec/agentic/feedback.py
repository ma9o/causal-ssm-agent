"""Typed model-spec validation and prompt-snapshot abstractions."""
...
ModelSpecValidationStatus = Literal[
    "idle",
    "accepted",
...
class ModelSpecValidationPacket:
    """Structured validation state persisted by the model-spec reducer."""

    status: ModelSpecValidationStatus
    summary: str
    model_feedback: str
    ...
    capture_context_output: bool = False


@dataclass(frozen=True)
class ModelSpecGroundingResult:
    """Typed result returned by model-spec grounding."""

    context_output: dict[str, Any] | None
    validation_packet: ModelSpecValidationPacket
...
def make_model_spec_validation_packet(
    *,
    status: ModelSpecValidationStatus,
    feedback: str,
    ...
    return ModelSpecValidationPacket(
        status=status,
        ...
        capture_context_output=capture_context_output,
    )


def make_model_spec_grounding_result(
    *,
    context_output: dict[str, Any] | None,
    status: ModelSpecValidationStatus,
    feedback: str,
    ...
    """Construct a typed model-spec grounding result."""
    return ModelSpecGroundingResult(
        context_output=context_output,
        validation_packet=make_model_spec_validation_packet(
            status=status,
            feedback=feedback,
