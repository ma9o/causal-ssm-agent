...
| prescription_renewals | medication_adherence | continuous | mean | Proportion of prescriptions renewed on time via Doctolib (0–1, quarterly) |
| appointment_attendance | medication_adherence | continuous | mean | Proportion of kept vs missed Doctolib appointments (0–1, quarterly) |
...
| appointment_attendance | beta | logit | Proportion bounded [0,1]; Doctolib attendance rate | — |
...
*Inference: laplace_em | 1000 samples | 42.5s*
