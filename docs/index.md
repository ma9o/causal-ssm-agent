...
| Primitives | The matching primitive page under `primitives/` | The domain semantics of `LatentModel`, `MeasurementModel`, `CausalSpec`, and `ModelSpec` |
| Model runtime | [model-runtime/compilation.md](model-runtime/compilation.md) | How Stage 4 outputs become executable inference |
...
- [`LatentModel`](primitives/latent-model/constructs-and-edges.md): construct ontology, edge legality, and lag semantics
- [`MeasurementModel`](primitives/measurement-model/indicators.md): indicators, extraction semantics, windows, aggregation, and `model_clock`
- [`CausalSpec`](primitives/causal-spec/identifiability.md): identifiability and the Stage 1b handoff contract
- [`ModelSpec`](primitives/model-spec/functional-specification.md): functional specification, parameter roles, likelihoods, and prior elicitation
...
| Which stage owns an artifact? | [concepts/pipeline-dimensions.md](concepts/pipeline-dimensions.md#artifact-index) | The owner stage doc |
...
| How does time work across extraction, fitting, and interventions? | [concepts/pipeline-dimensions.md](concepts/pipeline-dimensions.md#temporal-semantics) | [model-runtime/estimation.md](model-runtime/estimation.md) |
| What gets validated where? | [concepts/pipeline-dimensions.md](concepts/pipeline-dimensions.md#assurance-surface) | [pipeline.md](pipeline.md) |
